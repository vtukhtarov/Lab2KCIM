...
to setup
  ...
  ask patches
  [
      set pcolor green + (random-float 0.8) - 0.4 ;; varying the green just makes it look nice
  ]
...
"" ""
PENS
"efficiency" 1.0 0 -10899396 true "" "if ticks mod 50 = 0  ;; since the calculations are expensive\n[\n  update-sheep-counts\n  calculate-herding-efficiency\n  plotxy ticks herding-efficiency\n]"
"pen-1" 1.0 0 -2674135 true "" "if ticks mod 50 = 0  ;; since the calculations are expensive\n[\n  update-sheep-counts\n  calculate-herding-efficiency\n  plotxy ticks red-herding-efficiency\n]"
"pen-2" 1.0 0 -13345367 true "" "if ticks mod 50 = 0  ;; since the calculations are expensive\n[\n  update-sheep-counts\n  calculate-herding-efficiency\n  plotxy ticks blue-herding-efficiency\n]"
